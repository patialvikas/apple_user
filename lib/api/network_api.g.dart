...
class _RestClient implements RestClient {
  _RestClient(
    ...
    baseUrl ??= 'https://drapplehealthcare.com/public/api/';
  }
  ...
  Future<Checkotp> checkOtp(body) async {
    ...
    final _data = body;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Checkotp>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<CommonResponse> addAddressRequest(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<CommonResponse> deleteAddressRequest(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<Pharamacy> pharamacyRequest() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<Pharamacy>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<PharamaciesDetails> pharmacyDetailRequest(id) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PharamaciesDetails>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<CommonResponse> bookMedicineRequest(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<CommonResponse> cancelAppointmentRequest(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<CommonResponse> changePasswordRequest(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
