...
class HospitalId {
  ...
  HospitalId(
      {this.hospitalDistance, this.hospitalDetails, this.hospitalGallery});

  HospitalId.fromJson(Map<String, dynamic> json) {
    hospitalDistance = json['hospital_distance'];
    hospitalDetails = json['hospital_details'] != null
        ? new HospitalDetails.fromJson(json['hospital_details'])
        : null;
...
class HospitalDetails {
  ...
  HospitalDetails(
      {this.id, this.name, this.phone, this.address, this.facility});
