...
import 'package:apple_user/Firebasemodels/message_chat.dart';
    ...
    try {
      final response = await http.post(
        ...
        headers: <String, String>{
          ...
          'Authorization': "key=AAAAzoqfuq8:APA91bHco_Pppirs8YRBiRSgbgY36YU7sDBEHVmy4B-xFlbo72d0lMybehx7Ykd_dSv4eyb6XAQDklaPVnDeftYMAvo_jI8ZEku-d0IVye1txcmO2vnwWJPlX7_qeDuRqw06a5zb5DCU", //Enter_Your_Server_Key
        },
        body: jsonEncode(
          <String, dynamic>{
