...
class _DoctorDetailState extends State<DoctorDetail> with TickerProviderStateMixin {
                  ...
                  TabBar(
                    ...
                    tabs:  [
                      Tab(
                        ...
                        child: Align(
                          alignment: Alignment.center,
                          child: Text(getTranslated(context, doctorDetail_tab1_title).toString(),
                              style: TextStyle(
                                //color: Color(0xff8E90C7),
                                color: selectedTab_index==0?Color(0xff1C208F):Colors.white
                              )),
                        ),
                      ),
                      Tab(
                        child: Align(
                          alignment: Alignment.center,
                          child: Text(getTranslated(context, doctorDetail_tab2_title).toString(),
                              style: TextStyle(
                                //color: Color(0xff8E90C7),
                                  color: selectedTab_index==1?Color(0xff1C208F):Colors.white
                              )),
                        ),
                      ),
                      Tab(
                        child: Align(
                          alignment: Alignment.center,
                          child: Text(getTranslated(context, doctorDetail_tab3_title).toString(),
                              style: TextStyle(
                               // color: Color(0xff8E90C7),
                                  color: selectedTab_index==2?Color(0xff1C208F):Colors.white
                              )),
                        ),
                      ),
                    ],
          ...
          bottomNavigationBar: Container(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor:Color(0xff1C208F), // Background color
              ),
              child: Text(
  ...
  void _setActiveTabIndex() {
    selectedTab_index = _tabController!.index;
    setState(() {
