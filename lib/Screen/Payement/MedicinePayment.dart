import 'dart:convert';
import 'dart:io';
import 'package:apple_user/Screen/Payement/PaypalPaymentScreen.dart';
import 'package:apple_user/Screen/Payement/medicines_stripe_services.dart';
          ...
          onPressed: () async {
            if (deliveryType == 'Home') {
              if (address != null && address != "N/A") {
                ...
                if (_payment!.index == 2) {
                  print('Stripe');
                  Provider.of<MedicinesStripePayment>(context,listen: false).makePayment(context: context, pharamacyId: pharmacyId,
                      amount:  grandTotal.toString(), deliveryType: deliveryType, prescriptionFilePath: prescriptionFilePath, strFinalDeliveryCharge: strFinalDeliveryCharge, listData: listData);
                  // Navigator.pushReplacement(
                  //   context,
                  //   MaterialPageRoute(
              ...
              if (_payment!.index == 2) {
                print('Stripe');
                Provider.of<MedicinesStripePayment>(context,listen: false).makePayment(context: context, pharamacyId: pharmacyId,
                    amount: grandTotal.toString(), deliveryType: deliveryType,
                    prescriptionFilePath: prescriptionFilePath, strFinalDeliveryCharge: strFinalDeliveryCharge, listData: listData);
                // Navigator.pushReplacement(
                //   context,
                //   MaterialPageRoute(
                //     builder: (context) => StripePaymentScreenMedicine(
