...
import '../Payement/PaypalPaymentScreen.dart';
...
import '../Payement/StripePaymentScreen.dart';
import 'appoitment_stripe_service.dart';
                            ...
                            Container(
                              ...
                              child: CachedNetworkImage(
                                ...
                                errorWidget: (context, url, error) => ClipRRect(
                                  ...
                                  child: Image.asset("assets/images/NoImage.png", width: width * 0.2, height: width * 0.2, fit: BoxFit.fitHeight),
                                ),
                              ),
                            ),
                          ],
                    ...
                    children: [
                      Container(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: width * 0.045, color: Palette.dark_blue),
                        ),
                      ),
                      Container(
                        child: Text(
                ...
                () {
                  if (_currentStep == 0 && _step1.currentState!.validate()) {
                    ...
                    if (_character!.index == 0) {
                      ...
                      Provider.of<StripePayment>(context,
                          listen: false)
